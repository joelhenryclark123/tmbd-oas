...
module OpenapiClient
  class AccountLists200ResponseResultsInner
    attr_accessor :account_object_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AccountLists200ResponseResultsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AccountLists200ResponseResultsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'account_object_id')
        self.account_object_id = attributes[:'account_object_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          account_object_id == o.account_object_id &&
          adult == o.adult &&
    ...
    def hash
      [account_object_id, adult, average_rating, created_at, description, featured, id, iso_3166_1, iso_639_1, name, number_of_items, public, revenue, runtime, sort_by, updated_at].hash
    end
